...
class Input extends React.Component {
	...
	validatorContainer = () => {
		return (
			...
			? <PasswordValidator ref="passwordValidator" visible={this.state.validatorVisible} name={this.props.text} value={this.state.value} validData={this.state.isValidatorValid} valid={this.state.allValidatorValid} specialCharacters={this.state.specialCharacters} minCharacters={this.props.minCharacters} requireCapitals={this.props.requireCapitals} requireLowercase={this.props.requireLowercase} requireNumbers={this.props.requireNumbers}/>
			: null)
	}
